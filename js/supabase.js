...
function fillOnlineClassCode(){const input=document.getElementById("code");if(!input)return;const params=new URLSearchParams(location.search);const code=params.get("code");if(code)input.value=code.trim().toUpperCase()}
